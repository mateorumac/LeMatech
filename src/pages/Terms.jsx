...
const Terms = () => (
  <div className="terms-container">
    ...
    <p className="last-updated">Last updated: April 20, 2025</p>
    <p>
    ...
    <section>
      <h2>2. Definitions</h2>
      <p>
        For the purposes of these Terms and Conditions: <br></br> <br />
      ...
      <p>
        ...
        "Us" or "Our" in this Agreement) refers to LeMatech - Digital, KARDINALA
        ALOJZIJA STEPINCA 56, ČRNKOVCI.
      </p>
      <p>
      ...
      <p>
        <strong>Website</strong> refers to LeMatech - Digital, accessible from
        https://lematech-digital.com/
      </p>
      <p>
    ...
    <section>
      ...
      <p>
        ...
        <br />
        <br /> This website is informational only and is available to all users
        without age restrictions.
        <br />
        <br /> Your access to and use of the Service is also conditioned on Your
    ...
    <section>
      ...
      <p>
        ...
        are not owned or controlled by the Company. <br />
    ...
    <section>
      ...
      <p>
        ...
        USD if You haven't purchased anything through the Service. <br />
        <br />
    ...
    <section>
      ...
      <p>
        ...
        <br />
        <br /> Some jurisdictions do not allow the exclusion of certain types of
    ...
    <section>
      <h2>10. For European Union (EU) Users</h2>
      <p>
    ...
    <section>
      <h2>11. United States Legal Compliance</h2>
      <p>
    ...
    <section>
      ...
      <p>
        ...
        <a href="https://lematech-digital.com/en/#contact"target="_blank" rel="noopener noreferrer">lematech-digital.com/en/#contact
        </a>
      </p>
    </section>
  </div>
