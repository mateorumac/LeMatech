...
const PrivacyPolicy = () => (
  <div className="privacy-container">
    ...
    <section>
      ...
      <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to LeMatech - Digital, KARDINALA ALOJZIJA STEPINCA 56, ČRNKOVCI.</p>
      ...
      <p><strong>Website</strong> refers to LeMatech - Digital, accessible from lematech-digital.com</p>
    ...
    <section>
      ...
      <p>By visiting this page on our website: <a href="https://lematech-digital.com/en/#contact"target="_blank" rel="noopener noreferrer">lematech-digital.com/en/#contact
      </a></p>
    </section>
  </div>
);
